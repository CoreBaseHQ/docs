...
User attributes live on each member's **organization membership metadata** and are carried into their session token at sign-in. Set them per member from your organization settings.
