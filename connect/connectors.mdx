...
<Note>
  SaaS connectors are a **cloud-relay** tier — auth and proxied calls pass through the connector cloud. For legacy/on-prem databases, the **sovereign** path via [CoreMCP](/coremcp/intro) keeps data on your own network. Pick the tier your compliance needs.
</Note>
